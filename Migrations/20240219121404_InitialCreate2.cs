    ...
    public partial class InitialCreate2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActorFilmID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ActoriId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorFilme", x => x.ActorFilmID);
                    table.ForeignKey(
                        name: "FK_ActorFilme_Actori_ActorID",
                        column: x => x.ActorID,
                        principalTable: "Actori",
                        principalColumn: "ActorID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorFilme_Filme_FilmID",
                        column: x => x.FilmID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorFilme_ActorID",
                table: "ActorFilme",
                column: "ActorID");

            migrationBuilder.CreateIndex(
                name: "IX_ActorFilme_FilmID",
                table: "ActorFilme",
                column: "FilmID");
